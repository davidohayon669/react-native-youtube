...
export default class YouTube extends Component {
  ...
  getProgress(callback) {
    NativeModules.YouTubeModule.getProgress(callback);
  }

  _onChangeFullscreen(event) {
    this.props.onChangeFullscreen && this.props.onChangeFullscreen(event.nativeEvent);
  }
  ...
  render() {
    ...
    nativeProps.onChangeFullscreen = this._onChangeFullscreen.bind(this);

    // nativeProps.onChangeState = (e) => {
    ...
    if (this._exportedProps) {
      if (this._exportedProps.playerParams) {
        ...
        if (this.props.fullscreen) {
          nativeProps.playerParams.playerVars.fullscreen = this.props.fullscreen ? 1 : 0;
          delete nativeProps.fullscreen;
        }
